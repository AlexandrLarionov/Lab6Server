...
public class Ticket implements Serializable {
    ...
    public Ticket(Integer id, String name, Coordinates coordinates, Event e, double price, String t, LocalDateTime creationDate) {
        this.id = id;
        if (id == null) {
    ...
    public Ticket(Integer id, String name, Coordinates coords, LocalDateTime creationDate, double price, Event event, TicketType type) {
    }
    ...
    public String toString() {
        return "["+id+" " +name+" " + " "+coordinates.getX()+" "+ coordinates.getY()+" " + " " +event.getIdTicket() + " " + event.getNameTicket() + " " + event.getMinAge()+ " " + event.getTicketsCount() +  " " + price + " "+ type + "]";
    }
}
